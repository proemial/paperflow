...
const defaultValues = {
  ...
  messages: [
    ...
    },
    {
      ...
      content:
        'Analyse the following scientific article with title: $t and abstract: $a',
    },
    {
      role: ChatCompletionRequestMessageRoleEnum.User,
      content:
        'Write a captivating summary in 20 words or less of the most significant finding for an engaging tweet that will capture the minds of other researchers, using layman\'s terminology, and without mentioning abstract entities like "you", "researchers", "authors", "propose", or "study" but rather stating the finding as a statement of fact. Make sure to use 20 words or less and add three appropriate hashtags at the end to increase exposure of the tweet',
    },
  ],
};
...
export default function HomePage() {
  ...
  return <Prompt hash={defaultHash} />;
}
